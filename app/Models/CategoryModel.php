...
class CategoryModel extends Model // Defines a new class UserModel that extends CodeIgniter's Model class.
{
    protected $table = 'Category'; // Specifies the database table that this model should interact with.
    protected $primaryKey = 'category_id'; // Defines the primary key field of the table for CRUD operations.
