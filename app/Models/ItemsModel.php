...
class ItemsModel extends Model // Defines a new class UserModel that extends CodeIgniter's Model class.
{
    protected $table = 'Items'; // Specifies the database table that this model should interact with.
